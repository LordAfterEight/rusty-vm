...
- The memory is basically the communication layer between the CPU and the GPU and at the same time the thing that allows both to do literally anything. It's 128kiB in size (65536 16-bit addresses) and certain regions are always preprogrammed
